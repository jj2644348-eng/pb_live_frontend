...
// ---------------- GLOBAL DATA STORE (MOCK / LOCAL) ----------------
class AppData {
  static String myUserId = (10000000 + Random().nextInt(90000000)).toString(); // 8-Digit Unique ID
  static String myUserName = "Love Party Owner";
  static bool isSuperAdmin = true; // Owner flag
  static bool isCoinSeller = true; // Reseller flag
  static int myCoins = 5000000;

  // Registered Resellers List
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
          ...
          children: [
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: const [
                        Text("👑 Team A\n1,450 💎", textAlign: TextAlign.center, style: TextStyle(color: Colors.pinkAccent, fontWeight: FontWeight.bold)),
                        Text("VS", style: TextStyle(color: Colors.amber, fontSize: 20, fontWeight: FontWeight.bold)),
                        Text("🛡️ Team B\n980 💎", textAlign: TextAlign.center, style: TextStyle(color: Colors.cyanAccent, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ],
                ),
            ...
            Card(
              ...
              child: ListTile(
                ...
                subtitle: const Text("Play 100 💎 for fun", style: TextStyle(color: Colors.grey)),
                    ...
                    setState(() {
                      if (AppData.myCoins >= 100) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(win ? "🎉 Won +100 💎!" : "😢 Lost -100 💎"),
  ...
  // 4. ME (PROFILE, WALLET & OWNER PANEL)
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
              ...
              child: Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("💎 Virtual Diamond Balance", style: TextStyle(color: Colors.white70, fontSize: 12)),
                      const SizedBox(height: 4),
            ...
            // SUPER OWNER & COIN RESELLER PANEL BUTTON
...
class _OwnerAdminPanelScreenState extends State<OwnerAdminPanelScreen> {
  ...
  void transferCoins() {
    ...
    setState(() {
      AppData.myCoins += amount; // Super Owner minting / transferring
    });
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text("Successfully sent $amount 💎 Coins to User ID: $targetId", style: const TextStyle(color: Colors.white)),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: const Text("OK", style: TextStyle(color: Colors.pinkAccent)))
        ],
      ),
    );
  }

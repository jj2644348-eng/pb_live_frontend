# 🎙️ PB Live - Party Audio & Live Streaming App

> Developed by **Official Tech Love PB**  
...
2. Clone this repository or add the code to your `lib/main.dart`.
3. Run `flutter pub get` to install dependencies.
4. Run `flutter run` to launch the application on your device.
5. 

...
// ग्लोबल यूजर डेटा और ओनर स्टेट
String globalName = "Lovepreet Singh";
String? globalDpPath;
String globalUserId = "98234105"; // यूनिक 8-डिजिट आईडी
int globalCoins = 99999999; // ओनर के पास असीमित कॉइंस
bool isOwner = true; // ऑफिशियल ओनर स्टेटस
bool isMerchant = true; // कॉइन सेलर / मर्चेंट स्टेटस
...
class _ProfileViewState extends State<ProfileView> {
  ...
  void _openWhatsAppRecharge(int amount, int diamonds) async {
    final url = Uri.parse(
        "https://wa.me/919779353560?text=Hello%20Official%20Tech%20Love%20PB,%20I%20want%20to%20recharge%20%E2%82%B9$amount%20for%20$diamonds%20Diamonds.");
    if (await canLaunchUrl(url)) {
      await launchUrl(url, mode: LaunchMode.externalApplication);
    }
  }

  // ओनर / मर्चेंट कॉइन ट्रांसफर डायलॉग
        ...
        content: Column(
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: "Enter User 8-Digit ID", hintText: "e.g. 45892310"),
            ),
            TextField(
              controller: amountController,
              keyboardType: TextInputType.number,
              decoration: const InputDecoration(labelText: "Coins / Diamonds Amount", hintText: "e.g. 10000"),
            ),
          ],
        ),
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              if (transferAmt > 0 && globalCoins >= transferAmt) {
                setState(() {
                  globalCoins -= transferAmt; // भेजने वाले के कटे
                });
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text("Successfully transferred $transferAmt coins to ID: ${targetIdController.text}! 🎉")),
                );
              } else {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text("Insufficient coins or invalid amount!")),
                );
              }
            },
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: (globalDpPath != null && File(globalDpPath!).existsSync())
                          ...
                          : null,
                      child: (globalDpPath == null || !File(globalDpPath!).existsSync())
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        if (isOwner)
                          const Icon(Icons.verified, color: Colors.blueAccent, size: 18), // ब्लू टिक
                      ],
                    ),
...
// रॉकेट गेम क्लास (कंट्रोलेबल ओनर क्रैश गेम)
...
class _RocketGameState extends State<RocketGameView> {
  ...
  void _startRocket() {
    ...
    Future.doWhile(() async {
      ...
      // अगर ओनर ने फोर्स क्रैश दबा दिया या मल्टीप्लायर बहुत ऊपर चला गया
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: const Color(17, 7, 35), borderRadius: BorderRadius.circular(20)),
              child: Center(
                child: Text(
            ...
            if (!_isPlaying)
              ...
              ElevatedButton(
                ...
                onPressed: () => setState(() => _forceCrash = true), // ओनर का कंट्रोल: जब चाहे क्रैश कराओ!

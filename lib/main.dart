                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 10),
                      const Text('Choose Profile Avatar', style: TextStyle(color: Colors.white60, fontSize: 12)),
                      const SizedBox(height: 10),
                      SizedBox(
                        height: 50,
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _selectedAvatar == avatars[index] ? Colors.amber : const Color(0xFF221133),
                                  borderRadius: BorderRadius.circular(10),
                                ),
                                child: Text(avatars[index], style: const TextStyle(fontSize: 22)),
                              ),
                            );
                          },
                        ),
      ...
      child: Column(
        children: [
          CircleAvatar(
            radius: 45,
            backgroundColor: Colors.amber,
            child: Text(user.profileAvatar, style: const TextStyle(fontSize: 45)),
          ),
          const SizedBox(height: 15),

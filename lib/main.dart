...
// ग्लोबल यूजर और ओनर स्टेट
String globalName = "Official Owner";
String? globalDpPath;
String globalUserId = "000"; // ओनर की फिक्स आईडी '000'
...
// ग्लोबल सॉन्ग प्लेयर स्टेट (पूरे रूम के लिए)
final AudioPlayer globalAudioPlayer = AudioPlayer();
bool isGlobalSongPlaying = false;
...
class _ProfileViewState extends State<ProfileView> {
            ...
            ListTile(
              ...
              onTap: () {
                ...
                setState(() {
                  ...
                  vipLevel = 1;
                  freeLevel = 5;
                  globalCoins = 500; // आम यूजर्स को सीमित कॉइंस मिलेंगे
                });
                Navigator.pop(context);
  ...
  // ओनर स्पेशल कॉइन जनरेटर (सिर्फ ओनर ही अपने लिए फ्री अनलिमिटेड कॉइंस बढ़ा सकता है)
  void _mintOwnerCoins() {
    if (globalUserId == "000" || isOwner) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("❌ Only Owner (ID: 000) can mint coins! Users must purchase."))
      );
    }
  }
                    ...
                    children: [
                      ...
                      if (globalUserId == "000")
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Please purchase coins from the store!")));
                          },
  ...
  void _showGameDialog(String gameName) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text("Welcome to $gameName! Place your bets and win massive diamonds.", style: const TextStyle(color: Colors.white70)),
        actions: [
...
class _RoomViewState extends State<RoomView> {
  ...
  // सॉन्ग प्ले करने का असली फंक्शन
  void _playSong(String songTitle, String songUrl) async {
    try {
      await globalAudioPlayer.play(UrlSource(songUrl));
      setState(() {
        isGlobalSongPlaying = true;
        currentSongName = songTitle;
        _roomMessages.add("🎵 Playing Song: $songTitle");
      });
    } catch (e) {
      setState(() {
        isGlobalSongPlaying = true;
        currentSongName = songTitle;
        _roomMessages.add("🎵 Simulated Playing: $songTitle");
      });
    }
  }
  ...
  void _stopSong() async {
    ...
    setState(() {
      isGlobalSongPlaying = false;
      currentSongName = "No Song Playing";
      _roomMessages.add("⏹️ Music stopped.");
    });
  }

  void _showSongSelector(BuildContext context) {
    final List<Map<String, String>> playlist = [
      {"name": "PB Anthem Official Rap 🎧", "url": "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3"},
      {"name": "Punjabi Party Beat 💃", "url": "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3"},
      {"name": "Romantic Qawwali Mix 🌹", "url": "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3"},
    ];
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Now Playing: $currentSongName", style: const TextStyle(fontSize: 11, color: Colors.greenAccent)),
            const SizedBox(height: 10),
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    title: Text(playlist[index]['name']!, style: const TextStyle(color: Colors.white, fontSize: 12)),
                    trailing: ElevatedButton(
                      style: ElevatedButton.styleFrom(backgroundColor: Colors.purple.shade700),
                      onPressed: () {
                        Navigator.pop(context);
                        _playSong(playlist[index]['name']!, playlist[index]['url']!);
                      },
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text("Send Room Party Gifts", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.amber)),
            const SizedBox(height: 10),
            Expanded(
              child: GridView.builder(
                  ...
                  return ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      setState(() {
                        ...
                        freeLevel += 1; // गिफ्टिंग से फ्री लेवल बढ़ेगा
                      });
                    },
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("PB Live 12-Seat Party Room", style: TextStyle(fontSize: 15)),
        actions: [
          IconButton(

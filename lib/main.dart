  ...
  Future<void> _signInWithGoogle() async {
    try {
      ...
      if (googleUser != null) {
        final prefs = await SharedPreferences.getInstance();
        setState(() {
          globalName = googleUser.displayName ?? "PB User";
          if (googleUser.photoUrl != null) {
            globalDpPath = googleUser.photoUrl;
          }
        });
        await prefs.setString('p_name', globalName);
        if (globalDpPath != null) {
          await prefs.setString('p_dp', globalDpPath!);
        }
      }
    } catch (e) {
      // Handle error safely
                ...
                Stack(
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: (globalDpPath != null && globalDpPath!.startsWith('http'))
                          ? NetworkImage(globalDpPath!) as ImageProvider
                          : (globalDpPath != null && File(globalDpPath!).existsSync())
            ...
            child: Padding(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (ctx, i) {
                  ...
                  bool validImg = dp != null && (dp.startsWith('http') || File(dp).existsSync());
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: validImg
                                    ? DecorationImage(
                                        image: dp!.startsWith('http') ? NetworkImage(dp) as ImageProvider : FileImage(File(dp)),
                                        fit: BoxFit.cover,
                                      )
                                    : null,
                              ),

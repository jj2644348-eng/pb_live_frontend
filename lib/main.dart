...
// Simple In-Memory Database for storing user accounts securely by Mobile Number
class UserDatabase {
  ...
  void _authenticate(BuildContext context) {
    ...
    if (isLoginMode) {
      ...
      if (UserDatabase.users.containsKey(phone)) {
        ...
        // Go to Profile Setup for new user
        Navigator.push(
          context,
          MaterialPageRoute(
...
class MainHomeScreen extends StatefulWidget {
  ...
  const MainHomeScreen({super.key, required this.phone, required this.userName, required this.userGender});
...
class _MainHomeScreenState extends State<MainHomeScreen> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> pages = [
      ...
      ProfileTab(phone: widget.phone, userName: widget.userName, userGender: widget.userGender),
    ];
...
class ProfileTab extends StatelessWidget {
  ...
  const ProfileTab({super.key, required this.phone, required this.userName, required this.userGender});
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text('Phone: $phone', style: const TextStyle(color: Colors.white60, fontSize: 14)),

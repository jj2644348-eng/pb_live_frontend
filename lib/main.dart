...
class _MainNavState extends State<MainNav> {
  ...
  @override Widget build(BuildContext context) => Scaffold(
    body: [const HomeTab(), const RoomScreen(roomName: "PB VIP Audio Lounge"), const WalletTab(), const ProfileTab()][tab],
...
class _RoomScreenState extends State<RoomScreen> {
  final List<Map<String, dynamic>> seats = List.generate(15, (i) => {"user": i == 0 ? "Lovepreet\nID: 001 🛡️" : (i == 1 ? "Rani PB\nID: 48291043" : null), "muted": false});
  final List<String> feed = ["System: Welcome to PB Party Room!", "Rani (ID: 48291043) took seat 2."];
...
class WalletTab extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Scaffold(
    ...
    body: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: const [
      ...
      SizedBox(height: 10),
      Text("Owner ID: 001 (Official Reseller Rights)", style: TextStyle(color: Colors.amber, fontSize: 13))
    ])),
  );
}

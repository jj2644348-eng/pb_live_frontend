...
// User Database storing accounts with Unique 8-digit PB ID starting with '20'
class UserDatabase {
  static final Map<String, Map<String, dynamic>> users = {};

  static String generateUniquePBId() {
    final random = Random();
    // Generates 6 random digits to follow '20' making it an 8-digit ID starting with 20
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      // Generate Unique 8-digit PB ID starting with 20
...
class ProfileTab extends StatelessWidget {
  ...
  const ProfileTab({super.key, required this.pbId, required this.phone, required this.userName, requiredthis.userGender});

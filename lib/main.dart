                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Switch(
                      ...
                      onChanged: (v) => setState(() => isMaster = v),
                    ),
                  ],
                ),
              ),
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (c) => LiveAudioRoomScreen(roomData: newRoom),
                          ),
                        );
                      },
                      child: const Text(
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    "Transferred ${amtCtrl.text} Diamonds to ID: ${idCtrl.text}!",
                  ),

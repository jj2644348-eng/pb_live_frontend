        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (c) => LiveRoomScreen(roomData: newR, onUpdate: () => setState(() {}))),
              );
            },
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          userOnSeat != null ? userOnSeat["name"]! : "Seat ${index + 1}",
                          style: TextStyle(color: isSpeaking ? Colors.greenAccent : Colors.white70, fontSize: 10, fontWeight: FontWeight.bold),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                        if (isSpeaking)
                          const Text("🔊 Speaking", style: TextStyl

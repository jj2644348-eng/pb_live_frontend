...
String ownerWhatsApp = "+919876543210"; 
String? globalDpPath;
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            TextField(controller: targetIdController, decoration: const InputDecoration(labelText: "Enter User ID")),
            TextField(controller: amountController, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: "Coins Amount")),
          ],
        ),
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.pop(context);
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Coins transferred successfully! ✅")));
            },
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Contact Owner: Lovepreet Singh ($ownerWhatsApp)", style: const TextStyle(fontSize: 11, color: Colors.greenAccent)),
            const SizedBox(height: 10),
            Expanded(
        ...
        title: Row(
          children: [
            Image.asset(
              ...
              height: 26,
              width: 26,
              errorBuilder: (c, e, s) => const Icon(Icons.mic, color: Color(0xFFFF00FF), size: 22),
            ),
            const SizedBox(width: 8),

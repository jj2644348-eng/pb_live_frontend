            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 14),
                  const Text("Select Room Icon:", style: TextStyle(color: Colors.white70, fontSize: 13)),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        final roomName = titleCtrl.text.trim().isEmpty ? "${CurrentUser.name}'s Room" : titleCtrl.text.trim();
                        final newRoom = {

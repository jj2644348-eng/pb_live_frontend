          ...
          children: [
            ...
            const SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 20),
                  Text("Party", style: TextStyle(color: Colors.grey, fontSize: 16)),
                  SizedBox(width: 20),
                  Text("Gaming", style: TextStyle(color: Colors.grey, fontSize: 16)),
                  SizedBox(width: 20),
                  Text("Nearby", style: TextStyle(color: Colors.grey, fontSize: 16)),
                ],
              ),
            ),
            ...
            Expanded(
              child: GridView.builder(
                itemCount: 6, // डेमो रूम्स की संख्या
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      // किसी भी रूम पर क्लिक करने पर सीधे 12-सीट वाला रूम खुल जाएगा
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const TwelveSeatRoomScreen()),
                      );
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              ...
                              child: const Center(
                                child: Icon(Icons.mic, size: 40, color: Colors.white54),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Party Room #${index + 1}", style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 13)),
                                const SizedBox(height: 4),
                                const Row(
                                  children: [
                                    Icon(Icons.person, size: 12, color: Colors.grey),
                                    SizedBox(width: 4),
                                    Text("5/12 Seats", style: TextStyle(color: Colors.grey, fontSize: 10)),
                                  ],
                                ),
                              ],
                            ),
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  File? _imageFile; // डीपी बदलने के लिए फाइल वेरिएबल
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: _pickImage, // यहाँ क्लिक करने से गैलरी खुलेगी और डीपी बदलेगी
                          child: Container(
...
class TwelveSeatRoomScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        title: const Text("Party Room (12 Seats)", style: TextStyle(color: Colors.white, fontSize: 16)),
        actions: [
          IconButton(

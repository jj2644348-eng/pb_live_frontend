...
class _MainClubAppState extends State<MainClubApp> {
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("WhatsApp Official Direct Support: +91 97793 53560", style: TextStyle(color: Colors.greenAccent, fontWeight: FontWeight.bold, fontSize: 12)),
          ],
        ),
      ),
    );
            ...
            child: Column(
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: CurrentUser.customDpUrl.isNotEmpty ? NetworkImage(CurrentUser.customDpUrl) : null,
                  child: CurrentUser.customDpUrl.isEmpty ? Text(tempAvatar, style: const TextStyle(fontSize: 30)) : null,
                ),
                const SizedBox(height: 10),
  ...
  Widget _buildHomeScreen() {
    return Column(
      children: [
        // YouTube & Diamond Promotional Banners
        Padding(
            ...
            child: Row(
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: CurrentUser.customDpUrl.isNotEmpty ? NetworkImage(CurrentUser.customDpUrl) : null,
                  child: CurrentUser.customDpUrl.isEmp

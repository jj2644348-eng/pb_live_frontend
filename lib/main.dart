        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Select Pack (WhatsApp UPI Recharge):", style: TextStyle(color: Colors.white70, fontSize: 12)),
                        ...
                        trailing: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text("Recharge Request for ${p["diamonds"]}. WhatsApp: +91 97793 53560"), backgroundColor: Colors.green),
                            );
                          },
  ...
  void sendGift(Map<String, dynamic> gift) {
    ...
    if (CurrentUser.coins >= cost) {
      setState(() {
        ...
        chats.add("🎁 ${CurrentUser.name} sent ${gift["icon"]} ${gi

...
class _RoomViewState extends State<RoomView> {
  // 12 सीटों का डेटा: नाम, डीपी और माइक स्टेट (म्यूट/अनम्यूट)
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      setState(() {
                        if (occ) {
                          // अगर सीट पर पहले से यूजर है, तो टैप करने पर सीट खाली (Leave) हो जाएगी
                          _seats[i] = null;
                        } else {
                          // खाली सीट पर टैप करने पर करंट यूजर अपनी प्रोफाइल के साथ बैठ जाएगा
                          _seats[i] = {
                            'name': globalName,
                            'dp': globalDpPath,
                            'isMuted': false,
                      ...
                      children: [
                        Stack(
                          children: [
                            ...
                            // माइक स्टेटस आइकन (म्यूट या अनम्यूट)
                            if (occ)
                              Positioned(
                                bottom: 0,
                                right: 0,
          ...
          // रूम के नीचे चैट और गिफ्टिंग कंट्रोल बार
          Container(

...
List<Map<String, dynamic>> globalRooms = [
  {"id": "101", "name": "👑 Tech Love PB Official", "host": "Love Party Owner", "hostId": "0001", "active": "8/8 Live", "avatar": "👑"},
  {"id": "102", "name": "🔥 Punjabi Beats & Chill", "host": "Aman Deep", "hostId": "88451290", "active": "5/8 Live", "avatar": "🎤"},
  {"id": "103", "name": "🌹 Friends Gossip Club", "host": "Riya Sharma", "hostId": "55219034", "active": "3/8 Live", "avatar": "🎧"},
];
...
class _LoginAuthScreenState extends State<LoginAuthScreen> {
  ...
  void handleLogin() {
    ...
    if (isMaster) {
      ...
      CurrentUser.name = n.isEmpty ? "Club Member" : n;
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
                    ...
                    children: ["🔥", "👑", "🎤", "🌹", "💎", "⚔️"].map((emoji) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(color: selectedAvatar == emoji ? Colors.pinkAccent : const Color(0xFF2A2456), borderRadius: BorderRadius.circular(10)),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.pop(ctx);
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Connecting to WhatsApp: +91 97793 53560..."), backgroundColor: Colors.green));
            },
            child: const Text("Contact WhatsApp", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
  ...
  @override
  Widget build(BuildContext context) {
    final screens = [_buildHomeScreen(), _buildFamilyScreen(), _buildMeScreen()];
    return Scaffold(
      backgroundColor: const Color(0xFF0F0C20),
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: const BoxDecoration(color: Color(0xFF1A1635), border: Border(bottom: BorderSide(color: Color(0xFF2A2456)))),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Column(
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Text("💎 ${CurrentUser.coins}", style: const TextStyle(color: Colors.amberAccent, fontWeight: FontWeight.bold, fontSize: 13)),
                    ),
                    const SizedBox(width: 8),
                    IconButton(
                      icon: const CircleAvatar(radius: 16, backgroundColor: Color(0xFFFF007F), child: Icon(Icons.add, color: Colors.white, size: 20)),
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  const CircleAvatar(radius: 22, backgroundColor: Colors.black26, child: Text("👑", style: TextStyle(fontSize: 24))),
                  ...
                  Container(
                    ...
                    child: const Text("LIVE", style: TextStyle(color: Color(0xFFFF007F), fontWeight: FontWeight.bold, fontSize: 10)),
                  )
                ],
              ),
            ),
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: ElevatedButton(
                      style: ElevatedButton.styleFrom(backgroundColor: const Color(0

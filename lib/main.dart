    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(controller: targetIdController, decoration: const InputDecoration(labelText: "Enter User ID (e.g. 000 or 20xxxxxx)")),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              if (transferAmt > 0 && globalCoins >= transferAmt) {
                ...
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Transferred $transferAmt coins successfully! 🎉")));
              }
            },
  ...
  void _handleSeatTap(int index) {
    setState(() {
      if (_seats[index] == null) {
        // खाली सीट पर यूजर की आईडी और डीपी सेट करना
        _seats[index] = {
          'name': globalName,
          'dp': globalDpPath,
          'uid': globalUserId,
        ...
        // भरी हुई सीट पर क्लिक करने पर कंट्रोल पॉपअप दिखाना
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text(isMusicPlaying ? "Stop Room Music" : "Play Local Room Music 🎵", style: const TextStyle(color: Colors.white)),
              onTap: () {

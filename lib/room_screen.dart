      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // Gifting modal open karne ka action
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            // Mic Seats Grid (9 Seats Party Room Layout)
            Padding(
              ...
              child: GridView.builder(
                ...
                itemCount: 8, // 8 Mic Seats
                itemBuilder: (context, index) {
                  bool isOccupied = index < 3; // Pehle 3 seats par user hain, baki khali hain
                  return Column(
                    children: [
                      Stack(

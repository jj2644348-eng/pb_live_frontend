...
class _PartyRoomScreenState extends State<PartyRoomScreen> {
  // अब 8 की जगह कुल 15 माइक सीटें कर दी गई हैं
  ...
  // गिफ्ट भेजने वाला पॉप-अप फंक्शन (Gifting System)
  ...
  // सीट पर क्लिक करने पर माइक ऑप्शन
        ...
        child: SafeArea(
          child: Column(
            children: [
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: const [
                            ...
                            Text("15-Seater Party Room", style: TextStyle(color: Colors.white60, fontSize: 10)),
                          ],
                        ),
                      ],
                    ),
              ...
              // 15 सीटर माइक ग्रिड लेआउट (स्क્રોલ करने योग्य ताकि सारी सीटें आसानी से दिख सकें)
              Expanded(
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 12),
                  child: GridView.builder(
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 5, // एक लाइन में 5 सीटें (कुल 3 लाइनों में 15 सीटें)
                      crossAxisSpacing: 10,
                      mainAxisSpacing: 10,
              ...
              // नीचे बॉटम एक्शन बार (चैट और गिफ्टिंग बटन)
              Container(
                padding: const EdgeInsets.all(12),
